...
public partial class FeatureRollingOffer : FeatureDataRemoteConfig, IFeatureUpdatable
{
    public class Data
    {
        public int EventDuration
        {
            get
            {
                return RemoteConfigController.GetIntConfig("feature_rolling_offer_duration", 5);
            }
        }
        ...
        public int EventInterval
        {
            get
            {
                return RemoteConfigController.GetIntConfig("feature_rolling_offer_interval", 2);
            }
        }
    ...
    public FeatureRollingOffer(TypeFeature type, int levelUnlock = 0) : base(type, levelUnlock)
    {
        LoadData();
        CheckTimeReset();
    }
