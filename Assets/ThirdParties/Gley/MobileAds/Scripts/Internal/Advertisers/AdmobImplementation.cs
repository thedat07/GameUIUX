...
namespace Gley.MobileAds.Internal
{
    ...
    public class AdmobImplementation : MonoBehaviour, IAdProvider
    {
        ...
        private void BannerAdPaied(AdValue adValue)
        {
            ...
            TrackAdRevenue(adValue, banner.GetAdUnitID(), "banner", responseInfo);
        ...
        private void InterstitialAdPaied(AdValue adValue)
        {
            ...
            TrackAdRevenue(adValue, interstitial.GetAdUnitID(), "interstitial", responseInfo);
        ...
        {
            ResponseInfo responseInfo = appOpen.GetResponseInfo();
            TrackAdRevenue(adValue, appOpen.GetAdUnitID(), "appOpen", responseInfo);
        ...
        {
            ResponseInfo responseInfo = rewardedVideo.GetResponseInfo();
            TrackAdRevenue(adValue, rewardedVideo.GetAdUnitID(), "rewardedVideo", responseInfo);
        ...
        {
            ResponseInfo responseInfo = rewardedInterstitial.GetResponseInfo();
            TrackAdRevenue(adValue, rewardedInterstitial.GetAdUnitID(), "rewardedInterstitial", responseInfo);
        ...
        #region Log&Track
        private void TrackAdRevenue(AdValue adValue, string adUnitId, string adFormat, ResponseInfo responseInfo)
        {
            long valueMicros = adValue.Value;
            string currencyCode = adValue.CurrencyCode;
            double revenue = valueMicros / 1_000_000.0;

            string adSourceName = "unknown";
            string mediationGroupName = "none";
            ...
            if (responseInfo != null)
            {
                ...
                if (extras != null && extras.ContainsKey("mediation_group_name"))
            ...
            adRevenue.AdRevenuePlacement = mediationGroupName;
            Adjust.TrackAdRevenue(adRevenue);

            AdjustEventMap.LogAdComplete(adValue, adFormat);
        }
